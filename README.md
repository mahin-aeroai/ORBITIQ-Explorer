...
**Real-time space tracking & visualization platform** — satellites, asteroids, comets, meteor showers, and an interactive 3D Earth, styled as a NASA mission-control dashboard.

[![Live](https://img.shields.io/badge/🚀_Live-mahin--aeroai.github.io%2FORBITIQ--Explorer-22D3EE?style=for-the-badge)](https://mahin-aeroai.github.io/ORBITIQ-Explorer/)
...
| Project | What it is |
|---------|-----------|
| [ORBITAL NEXUS SSA](https://github.com/mahin-aeroai/ORBITAL-NEXUS-SSA) | Interactive explainer for the full SSA operational stack |
| [ORBITIQ NEXUS](https://github.com/mahin-aeroai/ORBITIQ-NEXUS) | Orbital density heatmap and knowledge graph canvas |
| [ASTRA WATCH](https://github.com/mahin-aeroai/ASTRA-Watch) | Ops monitoring dashboards, live ISS, space weather |
| [ORBITIQ-X](https://github.com/mahin-aeroai/ORBITIQ-X) | Full aerospace intelligence platform — KG, GraphRAG, multi-agent |

<div align="center">

**[Mahin Nandipa](https://mahin-nandipa.netlify.app)** · [GitHub](https://github.com/mahin-aeroai) · [LinkedIn](https://www.linkedin.com/in/mahin-nandipa-58189b392)
